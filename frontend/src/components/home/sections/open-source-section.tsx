      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            ...
            future of AI agents with thousands of developers worldwide.
          </p>
        </SectionHeader>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. OMNI Operator is built
                  in the open, for everyone, by everyone.
                </p>
              </div>
              ...
              <Button
                size="lg"
                className="relative pl-6 pr-14 group rounded-full"
                asChild
              >
                <motion.a
